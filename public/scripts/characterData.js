...
export const characterData = [
    ...
    },
    {
        ...
        requiredAchievementId: 'comeback_win',
        requiredAchievementLabel: '掟破りの奇兵',
        process: 'ult_lowen'
    },
    {
    ...
    },
    {
        ...
        charge: 8,
        chargeMax: 200,
        Ability: '無敵プレイヤー、ゲームスタート！',
        AbilityDetail: '【勝利】自分の勝利ポイントを＋１する。3ポイントに達した場合は即座に試合終了となる。',
        AbilityUseTurn: 1,
