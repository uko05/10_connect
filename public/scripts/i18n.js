...
const achDict = {
  en: {
    ...
    items: {
      ...
      'straight_win':       { name: 'Overwhelming Victory I',               condition: 'Win an online match 3-0 (1 time)' },
      'straight_win_5':     { name: 'Overwhelming Victory II',              condition: 'Win an online match 3-0 (5 times)' },
      'straight_win_10':    { name: 'Overwhelming Victory III',             condition: 'Win an online match 3-0 (10 times)' },
