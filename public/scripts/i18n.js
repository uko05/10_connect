...
const charaDict = {
  en: {
    '001': { name: 'Wanderer',           Ability: 'Forbidden Art: Act Five',              AbilityDetail: '[BREAK] Selects 4 random columns. Destroys the top 2 stones of each selected column. (Available from turn 15)' },
    '002': { name: 'Citlali',            Ability: 'Edict of All Stars',                   AbilityDetail: '[BREAK] Selects 3 random columns. Destroys the top 1 stone of each selected column. (Available from turn 6)' },
    '003': { name: 'Alhaitham',          Ability: 'Particular Field: Fetters',            AbilityDetail: '[BREAK] Selects 2 random columns from the center 3. Destroys all stones in those columns. (Available from turn 15)' },
    '004': { name: 'Navia',              Ability: 'Salute to the Fair Weather',           AbilityDetail: '[BREAK] Destroys all stones in the top 3 rows.' },
    '005': { name: 'Hanabi',             Ability: 'A Thousand Faces',                     AbilityDetail: "[EUPHORIA] For this turn and the opponent's next turn, placed stones appear in the opposite color. Win conditions use original colors. (Cannot be used if the opponent used this ability the previous turn.)" },
    '006': { name: 'Madam Herta',        Ability: 'I Said It Was Magic',                  AbilityDetail: '[BREAK] Selects 1 random column. Destroys all stones in that column. (Even empty columns can be selected)' },
    '007': { name: 'Castorice',          Ability: 'Wrath of the Dead, Bell of Rebirth',   AbilityDetail: '[BREAK] Selects 3 random columns from the 4 outer columns (2 on each side). Destroys all stones in those columns. (Available from turn 12)' },
    '008': { name: 'Aventurine',         Ability: 'Lord of the Roulette',                 AbilityDetail: "[SUPPORT] Reduces opponent's turn time limit by 19 seconds. Can be used up to 5 times." },
    '009': { name: 'Firefly',            Ability: 'Firefly-IV-Complete Combustion',       AbilityDetail: '[CONSECUTIVE] Selects 1 random column. Drops your stone into that column. (Available from turn 5)' },
    '010': { name: 'Ruan Mei',           Ability: 'Petals to Stream, Boundless Pith',     AbilityDetail: '[CONVERT/BREAK] Converts 3 random opponent stones to yours. Then destroys 6 of your stones at random. (Available from turn 13)' },
    '011': { name: 'Lohen',              Ability: 'Hour of Reckoning',                    AbilityDetail: '[BREAK] Destroys all stones in the 2nd row from the bottom. Stones above fall due to gravity. (Available from turn 10)' },
    ...
    '013': { name: 'Savel',              Ability: 'Phantom Thief Cat, Entering!',         AbilityDetail: "[COPY] Uses the same ability as the opponent. Does nothing if the opponent is also Savel." },
    '014': { name: 'Durin',              Ability: 'Law of the Obsidian: Smoldering Star', AbilityDetail: '[BREAK] Selects 2 random stones and destroys them. Reactivates at the start of your next turn with new stones. (Available from turn 8)' },
    '015': { name: 'Cerylua',            Ability: 'Veni, vidi, vici.',                    AbilityDetail: "[CURSE] On the opponent's next turn, after they place a stone, an additional opponent stone drops in the same column. If that column is full, it drops in a random column." },
    '016': { name: 'Silver Wolf LV.999', Ability: 'Unbeatable Player, Game Start!',       AbilityDetail: '[VICTORY] Adds +1 to your victory points. If you reach 3 points, the match ends immediately.' },
  },
};
...
const achDict = {
  en: {
    ...
    items: {
      ...
      'ult_five_win':       { name: 'Emperor of Law, Master of the Board', condition: 'Use an Ultimate 5+ times in one match and win' },
